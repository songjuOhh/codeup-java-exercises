...
//        List<Integer> numbers = new ArrayList<>();  // <do not use primitive types>
//        numbers.add(1);
//        numbers.add(2);
//        numbers.add(3);
//        numbers.add(1000);
...
//        System.out.println(numbers.remove(Integer.valueOf(1)));  // This will remove the one has value of '1'
//
//        System.out.println(numbers);
//
...
//        System.out.println(numbers);
        ...
        for (String stringGrp : strings){
            System.out.println("Your string is : " + stringGrp);
        }
        ...
        strings.remove("etc");
        System.out.println(strings);
        strings.removeAll(Collections.singleton("hello"));
        System.out.println(strings);
...
//        System.out.println(numbers.get(5));
        ...
        List<Integer> numbers = new ArrayList<>(Arrays.asList(1,2,3));  // <do not use primitive types>
...
//
        ...
        List<String> animals = new ArrayList<>(Arrays.asList(
                "apple","dog", "cat", "lion", "tiger","panda","dinosaur"
        ));
...
//
        usernames.putIfAbsent("Zach2", "coderdude24");
        System.out.println(usernames);
